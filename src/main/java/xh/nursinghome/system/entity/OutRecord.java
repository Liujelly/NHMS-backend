...
public class OutRecord {
    ...
    public OutRecord(Integer outboundNumber, Integer inboundNumber, String materialNumber, String materialName, float warehousingQuantity, String warehousingTime, String productionDate, String mSupplier, String shelfLife, String inOperator) {
        this.outboundNumber = outboundNumber;
        this.inboundNumber = inboundNumber;
        this.materialNumber = materialNumber;
        this.materialName = materialName;
